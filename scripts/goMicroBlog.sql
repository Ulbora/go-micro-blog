...
CREATE TABLE IF NOT EXISTS `go_micro_blog`.`user` (
  ...
  `disabled_for_cause` TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `go_micro_blog`.`rules`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_micro_blog`.`rules` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `content` LONGBLOB NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `go_micro_blog`.`tos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_micro_blog`.`tos` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `content` LONGBLOB NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `go_micro_blog`.`about`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_micro_blog`.`about` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `content` LONGBLOB NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `go_micro_blog`.`privacy_policy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_micro_blog`.`privacy_policy` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `content` LONGBLOB NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `go_micro_blog`.`home`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `go_micro_blog`.`home` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `content` LONGBLOB NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
